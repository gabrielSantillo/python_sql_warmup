...
INSERT INTO `item` VALUES (1,'Corolla',25000),(2,'Civic',26000),(3,'CR-V',30000),(4,'RAV4',32000),(5,'Focus',23000);
...
INSERT INTO `item_sale` VALUES (1,1,1),(2,2,4),(3,3,5),(4,2,5),(5,3,5),(6,1,4);
...
INSERT INTO `sales_person` VALUES (1,'Gabriel'),(2,'Natalia'),(3,'Daniel');
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_all_sales_person` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_all_sales_person`()
begin
...
/*!50003 SET collation_connection  = utf8mb4_unicode_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_item`(sales_person_id_input int unsigned, item_id_input int unsigned)
    MODIFIES SQL DATA
begin
	insert into item_sale (sales_person_id, item_id)
	values (sales_person_id_input, item_id_input);
	commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2022-09-27 17:00:06
